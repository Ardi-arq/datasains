...
# HEADER
# ========================================
st.markdown('<div class="main-header">🎓 Student Social Media & Mental Health Dashboard</div>', unsafe_allow_html=True)
st.markdown("""
...
with tab4:
    ...
    st.info("""
    📌 **Ringkasan Pola Kecanduan**
    - Kecanduan tinggi → jam tidur lebih rendah
...
# ========================================
st.markdown("---")
st.markdown("<center>📘 Dashboard Media Sosial & Kesehatan Mental Mahasiswa</center>", unsafe_allow_html=True)
